...
```
cd existing_repo
git remote add origin https://gitlab.com/samplegroup1502818/workweb_domain.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/samplegroup1502818/workweb_domain/-/settings/integrations)
